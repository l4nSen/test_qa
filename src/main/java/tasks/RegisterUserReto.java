...
public class RegisterUserReto implements Task {
    ...
    public <T extends Actor> void performAs (T actor){
        actor.attemptsTo(
                ...
                Enter.theValue(datosformulariolist.get(0).getPostalcode().trim()).into(Location.ZIP),
                ...
                Enter.theValue(datosformulariolist.get(0).getMobile().trim()).into(Devices.MOBILE),
